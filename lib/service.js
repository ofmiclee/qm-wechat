...
/**
 * 微信请求授权回调返回code，回调后直接请求获取token 返回授权方appid
 */
exports.oAuthCode = function *(code) {
  var componentToken = yield _getComponentToken();
  var authorizerTokenData = yield oAuth.getAuthorizerToken(componentToken, code);
  ...
  return authorizerToken.data.appid;
}
 ...
 */
exports.srvAccountInfo = function *(appid) {
  var componentToken = yield _getComponentToken();
  return yield oAuth.getAuthorizerInfo(componentToken, appid);
}
