...
exports.oAuthReq = function *() {
  ...
  this.body = oAuth.jump2OAuthPage(codeData.pre_auth_code, 'http://wechat.qianmi.com/oauth/code');
}
...
exports.oAuthCode = function *() {
  ...
  if (query.pre_auth_code) {
    var componentToken = yield _getComponentToken();
    var authorizerTokenData = yield oAuth.getAuthorizerToken(componentToken, query.pre_auth_code);
